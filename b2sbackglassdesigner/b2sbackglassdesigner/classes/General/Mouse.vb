...
Namespace Illumination
    ...
    Public Class Mouse
        ...
        Private reels As ReelAndLED.ReelCollection = Nothing
        ...
        Public Sub New(ByRef _parent As B2SPictureBox, ByRef _bulbs As Illumination.BulbCollection, ByRef _reels As ReelAndLED.ReelCollection)
            parent = _parent
            bulbs = _bulbs
            reels = _reels
        ...
        Private Sub Parent_MouseMove(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            ...
            Else
                parent.BackglassData.IsDirty = True
        ...
        Private Function CalcMouseLocation(ByVal x As Integer, ByVal y As Integer) As Cursor
            ...
            For Each reel As KeyValuePair(Of Integer, ReelAndLED.ReelInfo) In reels
                ret = CalcItem(reel.Value, x, y, currentBulbWithMouseOver)
                If ret = Cursors.Hand Then Exit For
            Next
            If ret = Cursors.Default Then
                For Each bulb As KeyValuePair(Of Integer, Illumination.BulbInfo) In bulbs
                    ret = CalcItem(bulb.Value, x, y, currentBulbWithMouseOver)
                    If ret = Cursors.Hand Then Exit For
                Next
            End If
            Return ret
        ...
        Private Function CalcItem(ByVal item As InfoBase, ByVal x As Integer, ByVal y As Integer, ByRef currentWithMouseOver As InfoBase) As Cursor
